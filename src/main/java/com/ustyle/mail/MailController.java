...
public class MailController {
	...
	public boolean sendMailAuth(HttpSession session, @RequestParam String email) {
		...
		return mailService.send(subject, sb.toString(), "guesthi1111@gmail.com", email, null);
	}

//	// 아이디 찾기
//	@RequestMapping(value = "/sendMail/id", method = RequestMethod.POST)
//	public String sendMailId(HttpSession session, @RequestParam String email, @RequestParam String captcha,
...
//			mailService.send(subject, sb.toString(), "guesthi1111@gmail.com", email, null);
...
//	public String sendMailPassword(HttpSession session, @RequestParam String id, @RequestParam String email,
...
//			userService.updateInfo(user.getNo(), "password", password); // 해당
//																		// 유저의
//																		// DB정보
//																		// 변경
//
