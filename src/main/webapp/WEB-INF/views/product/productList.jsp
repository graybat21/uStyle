...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Clothing : Everything Template</title>
        ...
        <!-- Clothing CSS -->
        <link rel='stylesheet' type='text/css' media='all' href='css/clothing-style.css' />
        <!-- Style Clothing CSS -->
        <link rel='stylesheet' type='text/css' media='all' href='css/style_clothing.css' />
                                                            ...
                                                            <div class="block-content">
                                                                ...
                                                                <div class="action-forgot">
                                                                    <div class="login_forgotpassword">
                                                                        ...
                                                                        <p><span>Don't have an account?</span><a class="create-account-link-wishlist" href="h#" title="Sign Up">Sign Up</a>
                                                                        </p>
                                                                    </div>
                                                                    <div class="actions">
                                                                                        ...
                                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                                            <div class="store-view">
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Clothing Store" href="#"><img class="img-responsive" src="http://placehold.it/180x140" alt="Clothing Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="#/index.php/?___store=furniture_eng"><img class="img-responsive" src="http://placehold.it/180x140" alt="Furniture Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Baby Store" href="#"><img class="img-responsive" src="http://placehold.it/180x140" alt="Baby Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Beauty Store" href="#"><img class="img-responsive" src="http://placehold.it/180x140" alt="Beauty Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Garden Store" href="#"><img class="img-responsive" src="http://placehold.it/180x140" alt="Garden Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                            ...
                                                                                            <div class="store-view" style="padding-top:15px">
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Computer Store" href="#"><img class="img-responsive" src="http://placehold.it/180x140" alt="Computer Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Jewelry Store" href="#"><img class="img-responsive" src="http://placehold.it/180x140" alt="Jewelry Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Shoes Store" href="#"><img class="img-responsive" src="http://placehold.it/180x140" alt="Shoes Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Lingerie Store" href="#"><img class="img-responsive" src="http://placehold.it/180x140" alt="Lingerie Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Sport Store" href="#"><img class="img-responsive" src="http://placehold.it/180x140" alt="Sport Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Swatch Store" href="#"><img class="img-responsive" src="http://placehold.it/180x140" alt="Swatch Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                            ...
                                                                                            <div class="store-view" style="padding-top:15px">
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Supermarket Store" href="#"><img class="img-responsive" src="http://placehold.it/180x140" alt="Supermarket Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Smartphone Store" href="#"><img class="img-responsive" src="http://placehold.it/180x140" alt="Smartphone Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Glass Store" href="#"><img class="img-responsive" src="http://placehold.it/180x140" alt="Glass Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                    ...
                                                                                    <ul class="menu-container">
                                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                                            <div class="menu-cate effect03 zoom-img">
                                                                                                <div>
                                                                                                    <a title="em-sample-title" href="category-one-column.html"><img class="img-responsive" src="http://placehold.it/500x316" alt="em-sample-alt" />
                                                                                                    </a>
                                                                                                </div>
                                                                                ...
                                                                                <li class="menu-item-vbox menu-item-depth-2 col-sm-6 menu-item-parent" style="">
                                                                                    <ul class="menu-container">
                                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                                            <div class="menu-cate effect03 zoom-img">
                                                                                                <div>
                                                                                                    <a title="em-sample-title" href="category-two-columns-left.html"><img class="img-responsive" src="http://placehold.it/500x316" alt="em-sample-alt" />
                                                                                                    </a>
                                                                                                </div>
                                                                                ...
                                                                                <li class="menu-item-vbox menu-item-depth-2 col-sm-6 menu-item-parent" style="">
                                                                                    <ul class="menu-container">
                                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                                            <div class="menu-cate effect03 zoom-img">
                                                                                                <div>
                                                                                                    <a title="em-sample-title" href="category-two-columns-right.html"><img class="img-responsive" src="http://placehold.it/500x316" alt="em-sample-alt" />
                                                                                                    </a>
                                                                                                </div>
                                                                                ...
                                                                                <li class="menu-item-vbox menu-item-depth-2 col-sm-6 menu-item-parent" style="">
                                                                                    <ul class="menu-container">
                                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                                            <div class="menu-cate effect03 zoom-img">
                                                                                                <div>
                                                                                                    <a title="em-sample-title" href="category-three-columns.html"><img class="img-responsive" src="http://placehold.it/500x316" alt="em-sample-alt" />
                                                                                                    </a>
                                                                                                </div>
                                                                        ...
                                                                        <li class="menu-item-hbox menu-item-depth-1 col-menu menu_col24 grid_24 menu-item-parent" style="">
                                                                            <ul class="menu-container" style="padding:0 10px">
                                                                                ...
                                                                                <li class="menu-item-vbox menu-item-depth-2 col-sm-12 grid_12 omega menu-item-parent" style="">
                                                                                    <ul class="menu-container">
                                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                                            <p class="img-banner-menu pull-right"><img class="img-responsive" src="http://placehold.it/560x374" alt="menu_adv" />
                                                                                            </p>
                                                                                        </li>
                                                                                    </ul>
                                                                                </li><!-- /.menu-item-vbox -->
                                                                            ...
                                                                            <ul class="menu-container" style="padding:0 10px">
                                                                                <li class="menu-item-vbox menu-item-depth-2 col-sm-9 menu-item-parent" style="">
                                                                                    <ul class="menu-container">
                                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                                            <p class="img-center">
                                                                                                <a href="#" title="em-sample-title"><img class="img-responsive" src="http://placehold.it/180x58" alt="em-sample-alt" />
                                                                                                </a>
                                                                                            </p>
                                            ...
                                            <div id="em-grid-mode">
                                                <ul class="emcatalog-grid-mode products-grid emcatalog-disable-hover-below-mobile">
                                                    ...
                                                    <li class="item">
                                                        <div class="product-item">
                                                            <div class="product-shop-top">
                                                                <a href="product-detail.html" title="WIASSI Version 12" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 12" /> <img id="product-collection-image-217" class="em-img-lazy img-responsive em-alt-org" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 12" /><span class="bkg-hover"></span> </a>
                                                                <div class="bottom">
                                                                    <div class="em-btn-addto text-center ">
                                                    ...
                                                    <li class="item">
                                                        <div class="product-item">
                                                            <div class="product-shop-top">
                                                                <a href="#" title="WIASSI Version 13" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 13" /> <img id="product-collection-image-218" class="em-img-lazy img-responsive em-alt-org" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 13" /><span class="bkg-hover"></span> </a>
                                                                <div class="bottom">
                                                                    <div class="em-btn-addto text-center ">
                                                    ...
                                                    <li class="item">
                                                        <div class="product-item">
                                                            <div class="product-shop-top">
                                                                <a href="#" title="WIASSI Version 14" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 14" /> <img id="product-collection-image-219" class="em-img-lazy img-responsive em-alt-org" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 14" /><span class="bkg-hover"></span> </a>
                                                                <div class="bottom">
                                                                    <div class="em-btn-addto text-center ">
                                                    ...
                                                    <li class="item">
                                                        <div class="product-item">
                                                            <div class="product-shop-top">
                                                                <a href="#" title="WIASSI Version 15" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 15" /> <img id="product-collection-image-220" class="em-img-lazy img-responsive em-alt-org" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 15" /><span class="bkg-hover"></span> </a>
                                                                <div class="bottom">
                                                                    <div class="em-btn-addto text-center ">
                                                    ...
                                                    <li class="item">
                                                        <div class="product-item">
                                                            <div class="product-shop-top">
                                                                <a href="#" title="WIASSI Version 16" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 16" /> <img id="product-collection-image-221" class="em-img-lazy img-responsive em-alt-org" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 16" /><span class="bkg-hover"></span> </a>
                                                                <div class="bottom">
                                                                    <div class="em-btn-addto text-center ">
                                                    ...
                                                    <li class="item">
                                                        <div class="product-item">
                                                            <div class="product-shop-top">
                                                                <a href="#" title="WIASSI Version 17" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 17" /> <img id="product-collection-image-222" class="em-img-lazy img-responsive em-alt-org" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 17" /><span class="bkg-hover"></span> </a>
                                                                <div class="bottom">
                                                                    <div class="em-btn-addto text-center ">
                                                    ...
                                                    <li class="item">
                                                        <div class="product-item">
                                                            <div class="product-shop-top">
                                                                <a href="#" title="WIASSI Version 18" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 18" /> <img id="product-collection-image-223" class="em-img-lazy img-responsive em-alt-org" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 18" /><span class="bkg-hover"></span> </a>
                                                                <div class="bottom">
                                                                    <div class="em-btn-addto text-center ">
                                                    ...
                                                    <li class="item">
                                                        <div class="product-item">
                                                            <div class="product-shop-top">
                                                                <a href="product-detail.html" title="WIASSI Version 19" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 19" /> <img id="product-collection-image-224" class="em-img-lazy img-responsive em-alt-org" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 19" /><span class="bkg-hover"></span> </a>
                                                                <div class="bottom">
                                                                    <div class="em-btn-addto text-center ">
                                                    ...
                                                    <li class="item">
                                                        <div class="product-item">
                                                            <div class="product-shop-top">
                                                                <a href="product-detail.html" title="WIASSI Version 11" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 11" /> <img id="product-collection-image-216" class="em-img-lazy img-responsive em-alt-org" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 11" /><span class="bkg-hover"></span> </a>
                                                                <div class="bottom">
                                                                    <div class="em-btn-addto text-center ">
                                                    ...
                                                    <li class="item">
                                                        <div class="product-item">
                                                            <div class="product-shop-top">
                                                                <a href="product-detail.html" title="WIASSI Version 10" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 10" /> <img id="product-collection-image-215" class="em-img-lazy img-responsive em-alt-org" src="http://placehold.it/220x220" width="220" height="220" alt="WIASSI Version 10" /><span class="bkg-hover"></span> </a>
                                                                <div class="bottom">
                                                                    <div class="em-btn-addto text-center ">
